...
cp /hdd2/dumps/Samsung/SM-A515F_XEF/recovery.img .
...
cp /hdd2/dumps/Samsung/SM-A515F_XEF/boot.img .
...
~phh/Downloads/magisk/x86/magiskboot hexpatch system/bin/recovery e10313aaf40300aa6ecc009420010034 e10313aaf40300aa6ecc009420010035
...
/build2/AOSP-11.0/out/host/linux-x86/bin/avbtool add_hash_footer --partition_name recovery --partition_size 71106560 --image r.img --key phh.pem --algorithm SHA256_RSA4096
